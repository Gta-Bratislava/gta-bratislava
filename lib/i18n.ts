...
export const dictionaries = {
  sk: {
    ...
    car: { year: "Rok", mileage: "Nájazd", fuel: "Palivo", transmission: "Prevodovka", power: "Výkon", engine: "Motor", body: "Karoséria", drive: "Pohon", financing: "Financovanie", perMonth: "od / mes.", detail: "Detail vozidla", description: "O vozidle", equipment: "Výbava", service: "Servisná história", damage: "Poškodenia a lakovanie", vin: "VIN", origin: "Pôvod vozidla", similar: "Podobné autá", whatsapp: "Napísať cez WhatsApp", call: "Zavolať", apply: "Mám záujem", testDrive: "Objednať testovaciu jazdu", zoom: "Zväčšiť fotografiu", available: "Skladom", reserved: "Rezervované", sold: "Predané", yes: "Áno", no: "Nie" },
    ...
    footer: { line: "Predaj, výber a kontrola automobilov v Bratislave.", rights: "Všetky práva vyhradené.", legal: "Právne informácie" },
  ...
  ua: {
    ...
    footer: { line: "Продаж, підбір і перевірка автомобілів у Братиславі.", rights: "Усі права захищено.", legal: "Правова інформація" },
  ...
  ru: {
    ...
    footer: { line: "Продажа, подбор и проверка автомобилей в Братиславе.", rights: "Все права защищены.", legal: "Правовая информация" },
  ...
  en: {
    ...
    financingPage: { eyebrow: "Vehicle financing", title: "A clear preliminary application", lead: "We help you prepare the information and submit the application to a financing company.", whoTitle: "Who can apply", who: "An adult with verifiable income and residence status that meets the partner’s requirements.", docsTitle: "What to prepare", docs: "Identification, proof of income or business activity, and residence details. Do not send sensitive documents through this standard form.", processTitle: "How it works", steps: ["Complete the preliminary application.", "We review the basic information and contact you.", "The financing company requests the required documents through a secure channel.", "After approval, you sign the agreement and collect the vehicle."], warning: "The financing company makes the final decision and sets the rate and terms. GTA_Bratislava does not guarantee approval." },
    ...
    footer: { line: "Vehicle sales, sourcing and inspections in Bratislava.", rights: "All rights reserved.", legal: "Legal information" },
