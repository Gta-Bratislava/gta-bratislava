...
export const financingInfo: Record<Locale, FinancingInfo> = {
  sk: {
    ...
    terms: [
      { label: "Suma financovania", value: "do 25 000 €" },
  ...
  ua: {
    ...
    terms: [
      { label: "Сума фінансування", value: "до 25 000 €" },
  ...
  ru: {
    ...
    terms: [
      { label: "Сумма финансирования", value: "до 25 000 €" },
  ...
  en: {
    ...
    terms: [
      { label: "Financing amount", value: "up to 25,000 €" },
