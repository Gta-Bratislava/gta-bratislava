...
5. Убедитесь, что результат — Success, затем заново откройте `/admin/`.
...
- в `financing_applications` добавлены выбранный автомобиль, параметры расчёта, ориентировочный платёж, итог и переплата;
